...
<simconf version="2023090101">
  <simulation>
    <title>P3 energia TSCH (nodo 1 = raiz)</title>
    ...
    <motetype>
      ...
      <source>[CONFIG_DIR]/energy-node.c</source>
      <commands>$(MAKE) TARGET=cooja clean
$(MAKE) -j$(CPUS) energy-node.cooja TARGET=cooja MAKE_MAC=MAKE_MAC_TSCH</commands>
  ...
  <plugin>
    ...
    <plugin_config>
      <pcap_file>[CONFIG_DIR]/../../resultados/p3-tsch.pcap</pcap_file>
  ...
  <plugin>
    ...
    <plugin_config>
      <scriptfile>[CONFIG_DIR]/energy.js</scriptfile>
      <active>true</active>
    </plugin_config>
